...
Conducted using Power Query, the process involved: formatting fields (e.g., income ranges), handling missing values, grouping job levels, ensured data type, standardizing ratings (e.g., environment satisfaction, job level), and applying binning and segmentation for clearer analysis.
